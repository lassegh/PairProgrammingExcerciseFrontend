...
function addRecord() {
    var addModelElement = document.getElementById("addModel"); // Finder model elementet
    var addVendorElement = document.getElementById("addVendor"); // Finder vendor elementet
    var addPriceElement = document.getElementById("addPrice"); // Finder price elementet
    var output = document.getElementById("contentAdd");
    var myModel = addModelElement.value; // henter model elementet til brug herinde
    var myVendor = addVendorElement.value; // henter vendor elementet til brug herinde
    var myPrice = Number(addPriceElement.value); // henter price elementet til brug herinde og konvertere string til number
