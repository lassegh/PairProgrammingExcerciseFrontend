...
function addRecord() {
    ...
    var addYearElement = document.getElementById("addYear");
    var addDurationElement = document.getElementById("addDuration");
    var divResponse = document.getElementById("postResponse");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUri, { artist: addArtistElement.value, title: addTitleElement.value, duration: addDurationElement.value, yearOfPublication: addYearElement.value })
        .then(function (response) {
